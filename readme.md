...
Read HDF5 is coded in Python code with a Jupyter Notebook provided by Institut Néel under the MaMMoS Project.
Package used to convert data obtained from high-throughput experiments into hdf5 datasets.
From these hdf5 datasets, a reader is provided to extract data into xarrays.
